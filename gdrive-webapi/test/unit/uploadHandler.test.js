...
describe("#UploadHandler", () => {
  ...
  describe("#handleFilesBytes", () => {
    ...
    test("given message timerDelay as 2secs it should emit only 2 message during 2 seconds period", async () => {
      jest.spyOn(ioObj, ioObj.emit.name);
  ...
  describe("#canExecute", () => {
    test("should return true when time is later then specified delay", () => {
      ...
      const tick3SecondsBefore = TestUtil.getTimeFromDate(
        "2021-07-01 00:00:00"
      );

      const lastExecution = tick3SecondsBefore;
